...
public class PagoForm extends javax.swing.JFrame {
    ...
    public PagoForm(IControl control, MenuPagosForm menuPagosForm, Pago pago, Empleado empleado, Integer operacion) {
        initComponents();
    ...
    private void llenarEmpleados() {
        ...
        List<Empleado> listaEmpleados = control.consultarEmpleados();
